module.exports = {
  ...
  theme: {
    extend: {
      // Reference your CSS variables for colors
      colors: {
        'clr-15': 'var(--color-clr-15)',
        'clr-3c': 'var(--color-clr-3c)',
        'clr-d6': 'var(--color-clr-d6)',
        'clr-45': 'var(--color-clr-45)',
        'clr-22': 'var(--color-clr-22)',
        'clr-ab': 'var(--color-clr-ab)',
        'clr-ce': 'var(--color-clr-ce)',
        'clr-4c': 'var(--color-clr-4c)',
        'clr-01': 'var(--color-clr-01)',
        'clr-1b': 'var(--color-clr-1b)',
        'clr-14': 'var(--color-clr-14)',
        bg: 'var(--color-clr-14)',
        'gray-300': 'var(--color-clr-ce)',
        'gray-600': 'var(--color-clr-45)',
        'green-900': 'var(--color-clr-15)',
        'stroke-2': 'var(--color-clr-4c)'
      },

      // Keep all your font configurations from the old setup
      fontFamily: {
