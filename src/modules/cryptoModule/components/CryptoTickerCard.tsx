import type { CardBody, CardContainer } from '@/components/ui/3d-card';
...
function CryptoCard() {
  return (
    <CardContainer className='h-full w-full'>
      <CardBody
        className='group/card relative h-full w-full overflow-hidden rounded-xl border border-black/[0.1] shadow-lg transition-all duration-300 hover:shadow-xl dark:border-white/[0.2] dark:hover:shadow-emerald-500/[0.1]'
        style={{
          background: 'var(--token-1b1d229e-ea68-4af5-b23e-bb03c92b8dd1, #161922)',
          backgroundImage: 'linear-gradient(135deg, #161922 0%, #000 100%)'
        }}
      >
        <div className='relative flex h-full w-full items-center overflow-hidden rounded-lg'>
          <motion.div
