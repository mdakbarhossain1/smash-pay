...
const DuoContentSection = () => {
  return (
    <section className='relative z-10 w-full overflow-hidden bg-[#0a0d14] px-4 py-20 lg:px-20'>
      {/* Background Circles */}
      {/* <div className='absolute -top-40 -left-40 h-96 w-96 rounded-full bg-green-300/10 blur-3xl' /> */}
      <div
        className='absolute -right-[367px] -bottom-40 h-96 w-96 rounded-full bg-purple-400/10 blur-3xl'
        style={{
          backgroundColor: 'var(--token-7d83949f-a967-48a3-8f07-15e8bd6e7d88, #50f8e4)',
          borderRadius: '524px',
          filter: 'blur(100px)',
          top: '-865px',
          opacity: 0.1,
      ...
      <div className='mx-auto flex max-w-7xl flex-col gap-8 p-6'>
        ...
        <div
          className='relative flex-1 overflow-hidden rounded-xl border border-gray-800 bg-gray-900 p-8'
          style={{
            background:
              'linear-gradient(45deg, var(--token-3ad3ba9a-ccc2-40b7-8c6f-fc587431b9c3, #31353f) 0%, var(--token-ad1f0f62-7edb-4a0e-83cc-532215fdd7d2, rgb(10, 13, 20)) 100%)'
          }}
        >
          ...
          <div className='mb-10 grid grid-cols-1 items-center gap-5 md:grid-cols-2'>
            ...
            <div className='relative z-10'>
              {/* Brand Boost Tag */}
              <div className='mb-4 inline-block rounded-md border border-purple-200/20 bg-purple-100/10 px-3 py-1 text-sm backdrop-blur-lg'>
              ...
              <div className='mb-8 space-y-3'>
                ...
                >
                  ...
                  <p className='text-md font-semibold text-white'>Fractional Ownership of Assets</p>
                </div>
                ...
                >
                  ...
                  <p className='text-md font-semibold text-white'>Increased Asset Liquidity</p>
                </div>
                ...
                >
                  ...
                  <p className='text-md font-semibold text-white'>Simplified Asset Transfer Process</p>
                </div>
              </div>
            ...
            {/* right */}
            <div className='mt-10 ml-auto md:mt-0'>
              <Image
            ...
            <div className='relative z-10 ml-auto'>
              ...
              <div className='mb-8 space-y-3'>
                ...
                >
                  ...
                  <p className='text-md font-semibold text-white'>Rapid Cross-Border Payments</p>
                </div>
                ...
                >
                  ...
                  <p className='text-md font-semibold text-white'>Low Transaction Fees</p>
                </div>
                ...
                >
                  ...
                  <p className='text-md font-semibold text-white'>Real-Time Transaction Tracking</p>
                </div>
              </div>
